...
set "pane-active-border-fg" "$onedark_red"
...
set "@prefix_highlight_bg" "$onedark_red"
set "@prefix_highlight_copy_mode_attr" "fg=$onedark_black,bg=$onedark_red"
